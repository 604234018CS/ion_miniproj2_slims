...
// get all todos
    $app->get('/todos', function ($request, $response, $args) {
         $sth = $this->db->prepare("SELECT * FROM  ORDER BY id_member");
        $sth->execute();
        $todos = $sth->fetchAll();
    ...
    $sth = $this->db->prepare("SELECT rentedroom.id_rentedroom,
    ...
    WHERE rentedroom.id_type = type.id_type AND type.id_type LIKE 't0002%' 
